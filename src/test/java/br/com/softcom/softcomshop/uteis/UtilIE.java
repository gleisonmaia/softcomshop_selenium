...
public class UtilIE {
	...
	private static void validaIEAmapa(String ie) throws Exception {
		...
		// das inscri&#65533;&#65533;es
		long x = Long.parseLong(ie.substring(0, ie.length() - 1)); // x = inscri&#65533;&#65533;o estadual sem o
																	// d&#65533;gito verificador
	...
	private static void validaIEBahia(String ie) throws Exception {
		...
		// C&#65533;lculo do m&#65533;dulo de acordo com o primeiro d&#65533;gito da
		// inscri&#65533;&#65533;o Estadual
		int modulo = 10;
	...
	private static void validaIEMinasGerais(String ie) throws Exception {
		 ...
		 * Munic&#65533;pio B= N&#65533;mero da inscri&#65533;&#65533;o C= N&#65533;mero
		 * de ordem do estabelecimento D= D&#65533;gitos de controle
		 */
		...
		// em inserir o algarismo zero "0" imediatamente ap&#65533;s o n&#65533;mero de
		// c&#65533;digo do munic&#65533;pio,
	...
	private static void validaIESaoPaulo(String ie) throws Exception {
		...
		if (ie.length() == 12) {
			...
			d1 = soma % 11;
			String strD1 = Integer.toString(d1); // O d&#65533;gito &#65533; igual ao algarismo mais a direita do
													// resultado de (soma % 11)
			...
			d2 = soma % 11;
			String strD2 = Integer.toString(d2); // O d&#65533;gito &#65533; igual ao algarismo mais a direita do
													// resultado de (soma % 11)
			...
			String strIE = ie.substring(1, 10); // Obt&#65533;m somente os d&#65533;gitos utilizados no c&#65533;lculo
												// do d&#65533;gito verificador
			int soma = 0;
			int peso = 1;
			int d1 = -1; // primeiro d&#65533;gito verificador
			// c&#65533;lculo do primeiro d&#65533;gito verificador (nona
